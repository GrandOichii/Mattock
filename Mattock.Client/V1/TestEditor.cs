	...
	: Control
{
	...
	public void OnListItemActivated(int idx)
	{
		...
		newTab.ObjectColors = new() {
			{ "Effect", 						new Color(1.00f, 1.00f, 0.00f, 1) },
			{ "ManaGroup", 						new Color(1.00f, 1.00f, 1.00f, 1) },
			{ "SingleEffect", 					new Color(1.00f, 0.80f, 0.30f, 1) },
			{ "Target", 						new Color(1.00f, 0.00f, 1.00f, 1) },
			{ "Target.Amount", 					new Color(0.60f, 0.10f, 0.10f, 1) },
			{ "Trigger", 						new Color(0.00f, 1.00f, 1.00f, 1) },
			{ "PlayerFilter", 					new Color(0.00f, 1.00f, 0.00f, 1) },
			{ "PlayerMany", 					new Color(0.00f, 0.66f, 0.00f, 1) },
			{ "PlayerSelect", 					new Color(0.00f, 0.33f, 0.00f, 1) },
			{ "PermanentFilter", 				new Color(1.00f, 0.60f, 0.00f, 1) },
			{ "PermanentSelect", 				new Color(0.60f, 0.40f, 0.00f, 1) },
			{ "PermanentMany", 					new Color(0.30f, 0.20f, 0.00f, 1) },
			{ "PermanentSingle", 				new Color(0.10f, 0.00f, 0.00f, 1) },
			{ "CardFilter", 					new Color(1.00f, 0.00f, 0.00f, 1) },
			{ "CardSelect", 					new Color(0.60f, 0.00f, 0.00f, 1) },
			{ "CardMany", 						new Color(0.33f, 0.00f, 0.00f, 1) },
			{ "TriggeredAbility", 				new Color(0.00f, 0.66f, 0.00f, 1) },
			{ "TriggeredAbilityCollection", 	new Color(0.00f, 0.33f, 0.00f, 1) },
			{ "ActivatedAbility", 				new Color(0.75f, 0.75f, 0.75f, 1) },
			{ "ActivatedAbilityCollection", 	new Color(0.50f, 0.50f, 0.50f, 1) },
			{ "ActivatedManaAbility", 			new Color(0.25f, 0.25f, 0.25f, 1) },
			{ "ActivatedManaAbilityCollection", new Color(0.10f, 0.10f, 0.10f, 1) },
			{ "Number", 						new Color(0.60f, 0.10f, 0.90f, 1) },
			// { "PlayerFilter", new Color(0.00f, 0.00f, 1.00f, 1) },
			// { "PlayerSelect", new Color(0.00f, 0.00f, 0.66f, 1) },
			// { "PlayerSingle", new Color(0.00f, 0.00f, 0.33f, 1) },
			{ "Cost", 							new Color(0.00f, 0.50f, 0.50f, 1) },
		{ "Mana", 								new Color(0.00f, 0.30f, 0.30f, 1) },
		};
