...
/// <summary>
/// Static class of common functions for Lua
/// </summary>
static class LuaCommon {
    /// <summary>
    ...
    static public LuaTable CreateTable<T>(Lua lState, T[] args) {
    ...
    static public long GetLong(LuaTable table, string name) {
        var f = table[name] as long? 
            ?? throw new GetLuaTableException(table, "Failed to get long " + name + " from Lua table ")
        ;
        return f;
    }
    ...
    static public bool GetBool(LuaTable table, string name) {
        var f = table[name] as bool?
            ?? throw new GetLuaTableException(table, "Failed to get bool " + name + " from Lua table ")
        ;
        return f;
    }
    ...
    /// <returns>Long value</returns>
    static public T Get<T>(LuaTable table, string name) where T : class {
        var raw = table[name]
    ...
    static public T[] ParseTable<T>(LuaTable table) {
